...
def read_data():
    path = r'E:/project_use/result_data_SY/result_data/'
    files = os.listdir(path)
    total = []
    for file in files:
        with open(path + file, 'r', encoding='utf-8', newline='') as csvfile:
...
def main():
    ...
    df_f.to_csv('E:/project_use/result_data_SY/tag_result.csv',sep='|' , columns=['id', 'post_time', 'content', 'score', 'Non_1','Parking','Elevator','MRT','Bus', 'Park','Convenience','Noise','Police_station','Management'])
